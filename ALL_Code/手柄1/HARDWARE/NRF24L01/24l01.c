...
{ 	
  ...
  SPI_InitTypeDef  SPI_InitStructure;
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA|RCC_APB2Periph_GPIOB|RCC_APB2Periph_SPI1, ENABLE);	 //使能时钟			
	...
	GPIO_ResetBits(GPIOB,GPIO_Pin_0|GPIO_Pin_1);//置低				 
...
void NRF24L01_RX_Mode(void)
{
	NRF24L01_CE=0;	  
  	...
  	NRF24L01_Write_Reg(NRF_WRITE_REG+RF_CH,70);	     //设置RF通信频率		  
...
{														 
	NRF24L01_CE=0;	    
  	...
  	NRF24L01_Write_Reg(NRF_WRITE_REG+RF_CH,70);       //设置RF通道为40
  	NRF24L01_Write_Reg(NRF_WRITE_REG+RF_SETUP,0x0f);  //设置TX发射参数,0db增益,2Mbps,低噪声增益开启   
